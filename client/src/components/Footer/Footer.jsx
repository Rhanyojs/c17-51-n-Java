...
const Footer = () => {
  return (
    <footer className="flex flex-col lg:flex-row gap-[30px] lg:gap-0 items-center lg:items-start  !text-center lg:!text-start h-[max-content] justify-between !m-[0] p-8 border-t-[1px] border-gray-200 overflow-x-hidden">
      ...
      <section className="flex flex-col w-[max-content] ">
        ...
        <ul className="pie_pagina__lista">
          <fieldset className="flex flex-col  items-center lg:items-start ">
      ...
      <section className="flex lg:min-h-[190px] items-end ">
        <ul className="flex h-full gap-3 items-end">
          <svg
