...
* @see https://v0.dev/t/TUN6WqYjTSh
  ...
  return (
    (<div>
      <section className="bg-[#f3f4f6] p-8">
        <div
          className="container mx-auto flex flex-col lg:flex-row items-start justify-between gap-8">
          <img
      ...
      <section className="py-12">
        <div className="container mx-auto space-y-8">
          <h2 className="text-3xl font-bold text-center">Professional care for your pets</h2>
          ...
          <div className="flex flex-wrap justify-center gap-8">
            ...
            <div className="flex flex-col items-center space-y-2">
              ...
              <h3 className="text-lg font-semibold">Initial brush & clip</h3>
              <p className="text-sm text-center">
            ...
            <div className="flex flex-col items-center space-y-2">
              <ShowerHeadIcon className="h-12 w-12 text-blue-500" />
              <h3 className="text-lg font-semibold">Dry</h3>
              <p className="text-sm text-center">
            ...
            <div className="flex flex-col items-center space-y-2">
              ...
              <h3 className="text-lg font-semibold">Full haircut</h3>
              <p className="text-sm text-center">
