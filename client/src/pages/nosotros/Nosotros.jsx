       ...
       <div className="nosotros">
        ...
        <p className="parrafo-nosotros">Desde nuestra fundación en 1999, hemos trabajado para brindar los mejores servicios de cuidado para sus perros y gatos. 
         ...
         <div className="container-beneficios">
            <div>
                            <svg className="icono-hueso" xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-bone" width="40" height="40" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#fd0061" fill="none" strokeLinecap="round" strokeLinejoin="round">
