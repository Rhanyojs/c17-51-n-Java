...
public class RegisterRequest {
    ...
    // Otras validaciones para los campos 'country' y 'location' si son necesarias
    // Ejemplo:
    @NotNull(message = "El campo 'country' es requerido")
    @NotEmpty(message = "El campo 'country' no puede estar vacío")
    String country;
